# AGENTS.md
If you are claude code, you can ignore this file. The contents are either in your plugins or global CLAUDE.md.
...
## Reference
Section 2 is from [forrestchang/andrej-karpathy-skills](https://github.com/forrestchang/andrej-karpathy-skills)
